<?php
    ...
    $fictrtrs = isset($_POST['fictrtrs']) ? $_POST['fictrtrs']:NULL;
    ...
    $firclbtrs = isset($_POST['firclbtrs']) ? $_POST['firclbtrs']:NULL;
    $firusutrs = isset($_POST['firusutrs']) ? $_POST['firusutrs']:NULL;
