...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2024 at 06:12 PM
...
CREATE TABLE `club` (
  ...
  `desclb` text DEFAULT NULL COMMENT 'Descripcion del club'
...
(2, 'Tipo de documento'),
(3, 'Tipo de noticia'),
(4, 'Tipo de comunicado'),
(5, 'Prioridad de noticia'),
(6, 'Prioridad de comunicado'),
(7, 'Tipo ntcm'),
(8, 'Estado ntcm'),
(9, 'Tipo de evento');
...
CREATE TABLE `inscripcion` (
  `idins` bigint(10) NOT NULL COMMENT 'Codigo de inscripcion',
...
CREATE TABLE `notcom` (
  ...
  `nomntcm` varchar(50) DEFAULT NULL COMMENT 'Nombre de la noticia o comunicado',
  `desntcm` text DEFAULT NULL COMMENT 'Descripcion de la noticia o comunicado'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(101, 'Inicio', 'views/vini.php', 1, 1, 'fa-solid fa-house'),
(102, 'Evento', 'views/veve.php', 1, 2, 'fa-solid fa-calendar-day'),
(103, 'Informacion', 'views/vinfo.php', 1, 3, 'fa-solid fa-circle-info'),
(104, 'Formacion', 'views/vfor.php', 1, 4, 'fa-solid fa-people-group'),
(105, 'Noticia', 'views/vnot.php', 1, 5, 'fa-solid fa-newspaper'),
(106, 'Amistoso', 'views/vamis.php', 1, 6, 'fa-solid fa-handshake-simple'),
(107, 'Torneo', 'views/vtor.php', 1, 7, 'fa-solid fa-trophy'),
...
(118, 'Valor', 'views/vval.php', 1, 18, NULL);
...
CREATE TABLE `plantilla` (
  ...
  `pospla` int(5) DEFAULT NULL COMMENT 'Posicion de plantilla'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(5, 4, 'Sebastian', NULL, '7c23cc4fd6bbeee2216560575d5de1ff910678ce', '1234567890', NULL, NULL, NULL, NULL, NULL, 3, 1, NULL, 1, NULL, 'jsparedessilva@gmail.com');
...
(1, 'Masculino', 1, NULL, 1),
(2, 'Feminino', 1, NULL, 1),
(3, 'Cedula de ciudadania', 2, NULL, 1),
(4, 'Tarjeta de identidad', 2, NULL, 1),
(5, 'Amistoso', 9, NULL, 1),
(6, 'Entrenamiento', 9, NULL, 1),
(7, 'Torneo', 9, NULL, 1),
(8, 'Liga', 9, NULL, 1);
...
--
ALTER TABLE `dominio`
  MODIFY `iddom` int(3) NOT NULL AUTO_INCREMENT COMMENT 'Codigo unico autoincrementable de dominio', AUTO_INCREMENT=10;
...
--
ALTER TABLE `inscripcion`
  MODIFY `idins` bigint(10) NOT NULL AUTO_INCREMENT COMMENT 'Codigo de inscripcion';
...
--
ALTER TABLE `valor`
  MODIFY `idval` int(5) NOT NULL AUTO_INCREMENT COMMENT 'Codigo unico autoincrementable del valor', AUTO_INCREMENT=9;
...
ALTER TABLE `plantilla`
  ...
  ADD CONSTRAINT `plaval` FOREIGN KEY (`pospla`) REFERENCES `valor` (`idval`),
